...
file_pattern = 'signs_%s_*.tfrecord'

# Create a dictionary that will help people understand your dataset better. This is required by the Dataset class later.
items_to_descriptions = {
    'image': 'A 3-channel RGB coloured of some person signing a letter in ASL.',
    'label': 'A letter in the english alphabet'
}
...
def get_split(split_name, dataset_dir, file_pattern=file_pattern):
    ...
    num_samples = 0
    file_pattern_for_counting = 'signs_' + split_name
